...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative min-h-[90vh] pb-12 pt-20 lg:pt-32 flex items-center justify-center overflow-hidden">
        {/* Background Effects */}
        <div className="absolute inset-0 bg-background">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-48 sm:w-96 h-48 sm:h-96 bg-accent/20 rounded-full blur-[60px] sm:blur-[120px] animate-pulse-soft" style={{ animationDelay: '1s' }} />
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full glass-sm border border-white/10 mb-6 sm:mb-8 animate-fade-in">
              <Zap className="w-3.5 h-3.5 text-primary" />
              <span className="text-[10px] sm:text-sm font-black uppercase tracking-widest text-foreground">Premium Digital Subscriptions</span>
            </div>
            ...
            <h1 className="text-4xl md:text-6xl lg:text-8xl font-display font-black text-foreground mb-4 sm:mb-6 animate-fade-in tracking-tighter leading-[0.9]" style={{ animationDelay: '0.1s' }}>
              Digital Subscriptions.<br />
              <span className="gradient-text">Instant Delivery.</span>
            </h1>

            <p className="text-sm md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 sm:mb-12 animate-fade-in font-medium px-4" style={{ animationDelay: '0.2s' }}>
              AI tools, design software, streaming & more — affordable, fast, and delivered straight to your WhatsApp.
            </p>

            <div className="flex flex-col sm:flex-row gap-3 justify-center animate-fade-in px-4 sm:px-0" style={{ animationDelay: '0.3s' }}>
              <Button variant="hero" size="xl" className="h-14 sm:h-16 text-sm sm:text-lg" asChild>
                <Link to="/products">
                  Explore Mart
                  <ArrowRight className="w-5 h-5 ml-2" />
                </Link>
              </Button>
              <Button variant="heroOutline" size="xl" className="h-14 sm:h-16 text-sm sm:text-lg glass-sm" asChild>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-8 mt-12 sm:mt-20 pt-8 sm:pt-12 border-t border-white/5 animate-fade-in" style={{ animationDelay: '0.4s' }}>
              <div className="p-2">
                <div className="text-xl sm:text-4xl font-black text-foreground mb-1">2K+</div>
                <div className="text-[9px] sm:text-xs text-muted-foreground uppercase font-black tracking-widest">Global Clients</div>
              </div>
              <div className="p-2 border-x border-white/5">
                <div className="text-xl sm:text-4xl font-black text-foreground mb-1">50+</div>
                <div className="text-[9px] sm:text-xs text-muted-foreground uppercase font-black tracking-widest">Premium Apps</div>
              </div>
              <div className="p-2">
                <div className="text-xl sm:text-4xl font-black text-foreground mb-1">24/7</div>
                <div className="text-[9px] sm:text-xs text-muted-foreground uppercase font-black tracking-widest">Live Help</div>
              </div>
            </div>
          </div>
        </div>
