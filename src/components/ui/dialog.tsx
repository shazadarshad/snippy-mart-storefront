    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          ...
          "flex h-10 w-10 sm:h-9 sm:w-9 items-center justify-center",
          "bg-background/90 border border-border text-foreground shadow-sm",
          "opacity-90 ring-offset-background transition-opacity",
