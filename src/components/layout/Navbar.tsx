        ...
        <div className="flex items-center justify-between h-14 lg:h-20">
          <Link to="/" className="flex items-center gap-2 group min-w-0">
            {logoUrl ? (
              ...
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-primary flex items-center justify-center transition-transform group-hover:scale-105 shadow-lg shadow-primary/20 shrink-0">
                <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-primary-foreground" />
              </div>
            )}
            <span className="text-sm sm:text-xl font-display font-black text-foreground uppercase tracking-tight truncate">
              {storeName.includes(' ') ? (
                <>
                  {storeName.split(' ')[0]}
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              className="md:hidden overflow-hidden glass-premium mt-2 mb-4 rounded-2xl"
            >
