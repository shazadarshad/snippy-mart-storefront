...
-- Syncing ALL templates to the same elite UI style
-- =====================================================

-- 1. ORDER CONFIRMATION (Re-verify/Sync)
                    ...
                    <tr>
                        <td align="center" style="padding: 0 40px;">
                            <div style="background: linear-gradient(135deg, rgba(34,197,94,0.1), rgba(22,163,74,0.1)); border: 1px solid rgba(34,197,94,0.2); border-radius: 20px; padding: 30px; text-align: center;">
                                ...
                                <p style="color: #22c55e; font-size: 14px; margin: 8px 0 0; font-weight: 600;">Processing in high priority</p>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 40px;">
                            ...
                            <p style="color: #94a3b8; font-size: 15px; line-height: 1.6; margin: 16px 0 0;">
                                Amazing choice! Your request has been queued for immediate fulfillment. 🚀
                            </p>
                            ...
                            <div style="margin-top: 32px;">
                                <p style="color: #ffffff; font-size: 16px; font-weight: 700; margin-bottom: 16px;">
                                    <span style="margin-right: 8px;">📦</span> Manifest
                                </p>
                        ...
                        <td style="padding: 0 40px 40px;">
                            <table class="buttons" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    ...
                                    <td width="4%" class="button-cell desktop-space">&nbsp;</td>
                                    <td class="button-cell" width="48%">
                    ...
                    <tr>
                        <td align="center" style="padding: 40px; background: rgba(0,0,0,0.5); border-top: 1px solid rgba(255,255,255,0.05);">
                            <p style="color: #475569; font-size: 10px; line-height: 1.6; margin: 0; text-transform: uppercase; letter-spacing: 1px;">
                                SECURE DIGITAL DELIVERY v2.0<br>
                                © 2026 SNIPPY MART. PREMIER SOLUTIONS.
                            </p>
                        </td>
                    </tr>
                </table>
                ...
                <table class="container" role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; background: linear-gradient(180deg, #10101a 0%, #050508 100%); border-radius: 32px; overflow: hidden; border: 1px solid rgba(255,255,255,0.08); box-shadow: 0 30px 60px rgba(0,0,0,0.5);">
                    ...
                    <tr>
                        <td style="padding: 40px 40px 0;">
                            <p style="color: #e2e8f0; font-size: 16px; line-height: 1.6; margin: 0;">Hi <strong style="color: #ffffff;">{{customer_name}}</strong> 👋</p>
                            <p style="color: #94a3b8; font-size: 15px; line-height: 1.6; margin: 16px 0 0;">
                                Success! Your premium access has been activated. Please keep these credentials secure.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 32px 40px;">
                            <div class="credentials-box" style="background: rgba(0,0,0,0.4); border: 2px solid rgba(168,85,247,0.4); border-radius: 24px; padding: 32px; position: relative;">
                                ...
                                <p style="color: #a855f7; font-size: 11px; font-weight: 800; text-transform: uppercase; letter-spacing: 2px; margin: 0 0 16px; opacity: 0.8;">🔐 Secure Data</p>
                    ...
                    <tr>
                        <td style="padding: 0 40px 40px;">
                            <a href="https://wa.me/94787767869" style="display: block; background: #25d366; color: #ffffff; text-decoration: none; padding: 20px; border-radius: 16px; font-weight: 800; font-size: 15px; text-align: center;">💬 WHATSAPP SUPPORT</a>
                        </td>
                    </tr>
...
-- 3. ORDER STATUS UPDATE (New Synced UI)
UPDATE public.email_templates 
SET html_content = '<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        @media only screen and (max-width: 600px) {
            ...
            h1 { font-size: 24px !important; }
            h2 { font-size: 20px !important; }
            .status-box { padding: 20px !important; }
        }
    </style>
</head>
<body style="margin: 0; padding: 0; background-color: #050508; font-family: ''Inter'', ''Segoe UI'', Roboto, Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: #050508;">
        <tr>
            <td align="center" style="padding: 20px 10px;">
                <table class="container" role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; background: linear-gradient(180deg, #0f0f1a 0%, #050508 100%); border-radius: 32px; overflow: hidden; border: 1px solid rgba(255,255,255,0.08); box-shadow: 0 30px 60px rgba(0,0,0,0.5);">
                    
                    <!-- Header -->
                    <tr>
                        <td align="center" style="padding: 40px 40px; background: radial-gradient(circle at top, rgba(0,184,212,0.1) 0%, transparent 70%);">
                            <img src="https://snippymart.com/android-chrome-192x192.png" alt="Snippy Mart" width="64" height="64" style="border-radius: 16px;">
                            <h1 style="color: #ffffff; font-size: 28px; font-weight: 800; margin: 20px 0 0; letter-spacing: -1px;">
                                Snippy<span style="color: #00b8d4;">Mart</span>
                            </h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 0 40px 30px;">
                            <p style="color: #64748b; font-size: 13px; font-weight: 600; text-transform: uppercase; tracking: 1px; margin-bottom: 24px;">Status Notification</p>
                            
                            <div class="status-box" style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 24px; padding: 32px; text-align: center;">
                                <p style="color: #64748b; font-size: 11px; text-transform: uppercase; font-weight: 800; letter-spacing: 2px; margin: 0 0 8px;">Order Reference</p>
                                <p style="color: #ffffff; font-size: 18px; font-weight: 800; margin: 0 0 24px; font-family: ''Courier New'', monospace;">#{{order_id}}</p>
                                
                                <div style="height: 1px; background: rgba(255,255,255,0.05); width: 60px; margin: 0 auto 24px;"></div>
                                
                                <p style="color: #64748b; font-size: 11px; text-transform: uppercase; font-weight: 800; letter-spacing: 2px; margin: 0 0 8px;">Current Phase</p>
                                <p style="color: #00b8d4; font-size: 28px; font-weight: 900; margin: 0; text-transform: uppercase;">{{status}}</p>
                            </div>
                            
                            <div style="margin-top: 32px; padding: 0 10px;">
                                <p style="color: #94a3b8; font-size: 15px; line-height: 1.8; margin: 0; text-align: center;">
                                    {{message}}
                                </p>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 0 40px 40px;">
                            <table class="buttons" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td class="button-cell" width="48%">
                                        <a href="https://snippymart.com/track-order?orderId={{order_id}}" style="display: block; background: #00b8d4; color: #ffffff; text-decoration: none; padding: 18px; border-radius: 16px; font-weight: 800; font-size: 14px; text-align: center; box-shadow: 0 10px 20px rgba(0,184,212,0.2);">🔍 LIVE TRACK</a>
                                    </td>
                                    <td width="4%" class="button-cell">&nbsp;</td>
                                    <td class="button-cell" width="48%">
                                        <a href="https://wa.me/94787767869" style="display: block; background: rgba(37,211,102,0.1); color: #25d366; text-decoration: none; padding: 18px; border-radius: 16px; border: 1px solid #25d366; font-weight: 800; font-size: 14px; text-align: center;">💬 SUPPORT</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
